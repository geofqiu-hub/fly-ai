...
export function Sidebar({ onOpenSettings, onSelectSession, currentSessionId, onNewSession, refreshTrigger, onDeleteSession, isCollapsed = false, onToggleCollapse }: Props) {
  ...
  return (
    <div className={clsx(
      ...
      {isCollapsed && (
        <div className="flex-1 flex flex-col items-center py-6 gap-4 px-1">
          <button
            onClick={onNewSession}
